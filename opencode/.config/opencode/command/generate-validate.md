...
Analyze this codebase deeply and create `.opencode/command/validate.md` that comprehensively validates everything.
...
Create `.opencode/command/validate.md` with these phases (ONLY include phases that exist in the codebase):
...
Write the generated validation command to `.opencode/command/validate.md`
